      ...
      setupSteps: [
        {
          ...
          note: "The wizard will ask whether you want a single chat or group chat, then let you choose a session duration from 30 minutes to permanent.",
          featured: true,
          variant: "recommended",
        },
        {
        ...
        {
          step: "Backup",
          title: "Then restart and generate the invite",
          body: "If you used the manual path, restart the OpenClaw gateway and then create a room invite from any existing OpenClaw chat channel.",
      ...
      setupSteps: [
        {
          ...
          commands: ["npx -y @privateclaw/privateclaw@latest"],
          note: "向导会询问你要单聊还是群聊，并让你选择会话时长：30 分钟、2/4/8/24 小时、1 周、1 个月、1 年或永久。",
          featured: true,
          variant: "recommended",
        },
        {
        ...
        },
        {
          step: "备用",
          title: "然后重启并生成邀请",
          body: "如果你走的是手动路径，重启 OpenClaw gateway，然后在任意现有的 OpenClaw 聊天渠道里生成二维码邀请。",
          commands: ["/privateclaw", "/privateclaw group"],
      ...
      setupSteps: [
        {
          ...
          commands: ["npx -y @privateclaw/privateclaw@latest"],
          note: "精靈會詢問你要單聊還是群聊，並讓你選擇會話時長：30 分鐘、2/4/8/24 小時、1 週、1 個月、1 年或永久。",
          featured: true,
          variant: "recommended",
        },
        {
        ...
        },
        {
          step: "備用",
          title: "然後重新啟動並產生邀請",
          body: "如果你走的是手動路徑，重新啟動 OpenClaw gateway，然後在任意既有的 OpenClaw 聊天渠道裡產生 QR 邀請。",
          commands: ["/privateclaw", "/privateclaw group"],
